...
**`r s_table("rogues")`**.
GenBank accessions identified as rogues by all-by-all BLAST.
...
```{r seqlen, fig.width = 7, fig.height = 4, eval = params$doc_type != "manual"}
...
```{r ts-fossil-map-save, eval = params$doc_type == "doc"}
ggsave(
  plot = fossil_map_plot,
...
Consensus phylogeny (Sanger dataset) with node labels indicating placement of fossil constraints of @Testo2016a.
Number for each constraint is age in Ma.
