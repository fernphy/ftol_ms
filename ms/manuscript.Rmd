...
sanger_tree <- ape::read.tree(here::here("working/sanger_alignment_2022-02-02.tre"))
```
...
We applied a set of `r nrow (plastid_calibration_dates)` calibration points as minimum ages.
...
However, current plastome sampling does not include all genera of Gleicheniales; additional taxon sampling may help to resolve this relationship.
