...
assertthat::assert_that(
  extract_iqtree_mod(sanger_iqtree_log) == 
    extract_iqtree_mod(plastome_iqtree_log),
...
a <- ggtree(
  sanger_tree_dated, layout = "circular", right = FALSE, size = 0.1) + 
  ftol_geom_cladelab(
