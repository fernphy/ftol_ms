...
We selected `r n_calibrations_ferns` fern fossils to use as calibration points from a curated list of `r n_fern_fossils_total` fern fossil taxa (`r s_table("fossils")`, Appendix S2).
