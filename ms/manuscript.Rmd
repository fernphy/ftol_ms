...
We selected `r n_calibrations_ferns` fern fossils to use as constraints from a curated list of `r n_fern_fossils_total` fern fossil taxa (`r s_table("fossils")`, Appendix S2).
...
The best-scoring model according to BIC selected for the backbone phylogeny was `r extract_iqtree_mod(plastome_iqtree_report)`.
