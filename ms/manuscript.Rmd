...
Global fern phylogenies have been published periodically, but as molecular systematics research continues at a rapid pace, these quickly become outdated.
...
While we consider our phylogeny may serve as a guide for future taxonomic revisions, we did not make any taxonomic changes that would require valid publication according to the International Code of Nomenclature for Algae, Fungi, and Plants FIXME <<add citation>>.
...
The final selection of Sanger loci (one set of concatenated accessions per species or one accession per species if conditions for concatenation not met) included `r n_accs_raw_final` accessions (`r n_accs_final` sequences when counting distinct loci within each accession separately; `r s_table("accs")`).
