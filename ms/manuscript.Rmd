...
The consensus tree had higher log-likelihood (`r best_con_score`) than the ML tree (`r best_ml_score`), so we only present the topology and divergence times estimated from the consensus tree.
