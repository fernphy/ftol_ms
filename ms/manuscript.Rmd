...
The "pteridocat" package includes the pteridcat taxonomic database as a data frame (tibble) in Darwin Core format.
...
tibble(
	Polypodiineae = c("Hypodematiaceae", "Davalliaceae"),
	Aspleniineae = c("Cystopteridaceae", "Athyriaceae"),
	Lindsaeineae = c("Lindsaeaceae", "Cystodiaceae"),
	Cyatheales = c("Cyatheaceae", "Plagiogyriaceae"),
	Salviniales = c("Marsileaceae", "Salviniaceae"),
	Schizaeales = c("")
) %>%
	pivot_longer(names_to = "plot_group", values_to = "taxa", cols = everything()) %>%
	arrange(plot_group) %>%
